...
export function useTextareaResize(
	...
	useLayoutEffect(() => {
		...
		if (textArea) {
			...
			textArea.style.height = "0px"; // Changed from "auto" to "0px" for more reliable scrollHeight calculation
			const scrollHeight = Math.max(textArea.scrollHeight, minHeight);

			// Set the final height
			textArea.style.height = `${scrollHeight + 2}px`; // +2 for a little extra buffer
		}
